...
¡Hola! Soy **Darío**, desarrollador y estudiante de Ingeniería de Sistemas. Trabajo en backend, frontend y bases de datos, y actualmente me especializo en análisis de datos,  machine learning y deep learning, combinando software + IA para crear soluciones con impacto real.
...
Data Science & AI:
  - Análisis de datos con Pandas, NumPy, SQL
  - Machine Learning & Deep Learning (scikit-learn, TensorFlow, Rasa)
  - Modelos predictivos y soluciones inteligentes
  
Database Engineering:
  - Diseño y optimización de bases de datos SQL
  - MySQL, PostgreSQL, SQL Server, Couchbase
  
Product Design:
  - Prototipado y diseño de interfaces con Figma
  - Construcción de plataformas end-to-end
```
...
<p align="left">
  ...
  <a href="mailto:darioestebangomez3@gmail.com">
...
Desarrollar soluciones inteligentes que unan **código + datos + diseño**, alineadas con mi sello personal:

> **Develop. Analyze. Evolve.**
---

<p align="center">
  <i>💡 "Code is poetry, data is the story, and design is the art."</i>
</p>
